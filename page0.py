...
#
# Created: Wed Nov 13 15:41:05 2013
...
class Ui_Page0(object):
    ...
    def retranslateUi(self, Page0):
        ...
        self.label.setText(QtGui.QApplication.translate("Page0", "<html><head/><body><p>Welcome to the EAF wizard!</p><p>This plugin will guide you through an Ecosystem\'s approach to Fisheries, using GIS.</p><p>Please Press &quot;Next&quot; to start adding data.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
