...
#
# Created: Mon Oct 21 09:33:50 2013
...
class Ui_Page4(object):
    ...
    def retranslateUi(self, Page4):
        ...
        Page4.setSubTitle(QtGui.QApplication.translate("Page4", "Stakeholder Analysis and Engagement", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cmbBathymetry.setItemText(0, QtGui.QApplication.translate("Page4", "Please choose one...", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbBathymetry.setItemText(1, QtGui.QApplication.translate("Page4", "Free-hand interactive", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbBathymetry.setItemText(2, QtGui.QApplication.translate("Page4", "By grid-cell", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbBathymetry.setItemText(3, QtGui.QApplication.translate("Page4", "Rule-based", None, QtGui.QApplication.UnicodeUTF8))
        self.checkLandingSites.setText(QtGui.QApplication.translate("Page4", "Landing Sites", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbLandingSites.setItemText(0, QtGui.QApplication.translate("Page4", "Please choose one...", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbLandingSites.setItemText(1, QtGui.QApplication.translate("Page4", "Free-hand interactive", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbLandingSites.setItemText(2, QtGui.QApplication.translate("Page4", "By grid-cell", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbLandingSites.setItemText(3, QtGui.QApplication.translate("Page4", "Rule-based", None, QtGui.QApplication.UnicodeUTF8))
        self.checkFishingAreas.setText(QtGui.QApplication.translate("Page4", "Fishing Areas", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbFishingAreas.setItemText(0, QtGui.QApplication.translate("Page4", "Please choose one...", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbFishingAreas.setItemText(1, QtGui.QApplication.translate("Page4", "Free-hand interactive", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbFishingAreas.setItemText(2, QtGui.QApplication.translate("Page4", "By grid-cell", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbFishingAreas.setItemText(3, QtGui.QApplication.translate("Page4", "Rule-based", None, QtGui.QApplication.UnicodeUTF8))
